...
Run the Composer require command from the Terminal:
    ...
    composer require miladtech/shoppingcart
...
You definitely should publish the `config` file and take a look at it.
    ...
    php artisan vendor:publish --provider="MiladTech\Shoppingcart\ShoppingcartServiceProvider" --tag="config"
...
use MiladTech\Shoppingcart\Contracts\InstanceIdentifier;
...
To make your life easy, the package also includes a ready to use `migration` which you can publish by running:
    ...
    php artisan vendor:publish --provider="MiladTech\Shoppingcart\ShoppingcartServiceProvider" --tag="migrations"
...
The calculation logic for the package is implemented and defined in `Calculator` classes. These implement the `MiladTech\Shoppingcart\Contracts\Calculator` Contract and and determine how the prices are calculated and rounded. The calculators can be configured in the confugration file. This is the default calculator:
```php
<?php

namespace MiladTech\Shoppingcart\Calculation;

use MiladTech\Shoppingcart\CartItem;
use MiladTech\Shoppingcart\Contracts\Calculator;
