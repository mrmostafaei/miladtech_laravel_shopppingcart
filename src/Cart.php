...
namespace MiladTech\Shoppingcart;

use Carbon\Carbon;
use Closure;
use MiladTech\Shoppingcart\Contracts\Buyable;
use MiladTech\Shoppingcart\Contracts\InstanceIdentifier;
use MiladTech\Shoppingcart\Exceptions\CartAlreadyStoredException;
use MiladTech\Shoppingcart\Exceptions\InvalidRowIDException;
use MiladTech\Shoppingcart\Exceptions\UnknownModelException;
...
class Cart
{
     ...
     * @param array     $options
     *
     * @return \MiladTech\Shoppingcart\CartItem
     */
     ...
     * Add an item to the cart.
     *
     * @param \MiladTech\Shoppingcart\CartItem $item          Item to add to the Cart
     * @param bool                              $keepDiscount  Keep the discount rate of the Item
     * @param bool                              $keepTax       Keep the Tax rate of the Item
     * @param bool                              $dispatchEvent
     *
     * @return \MiladTech\Shoppingcart\CartItem The CartItem
     */
